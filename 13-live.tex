...
\begin{quote}
\subsection{Up and Down}\label{up-and-down}

What are some of the advantages and challenges of live coding from both
a learner's and an instructor's point of view? \{: .discussion\}
\end{quote}
...
poorly} and this video of \href{https://youtu.be/SkPmwe_WjeY}{live
...
\href{https://en.wikipedia.org/wiki/Lectern\#Academic_context}{lectern}.
