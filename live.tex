\chaplbl{Live Coding}{sec:live}{0}{0}
...
\seclbl{Why Live Coding?}{sec:why-live-coding}
...
discussed in \secref{sec:performance}.
\end{challenge}
...
\seclbl{Live Coding Top 10}{sec:live-coding-top-10}

Below follow ten tips to help you get started with effective live
coding:

\seclbl{Be Seen and Heard}{sec:be-seen-and-heard}
...
\seclbl{Take It Slow}{sec:take-it-slow}
...
\seclbl{Mirror Your Learner's Environment As Much As Possible}{sec:mirror-your-learners-environment-as-much-as-possible}
...
\seclbl{Use The Screen Wisely}{sec:use-the-screen-wisely}
...
\seclbl{Use Illustrations}{sec:use-illustrations}
...
\seclbl{Avoid Being Disturbed}{sec:avoid-being-disturbed}
...
\seclbl{Stick to the Lesson Material}{sec:stick-to-the-lesson-material}
...
\seclbl{Leave No Learner Behind}{sec:leave-no-learner-behind}
...
\seclbl{Embrace Mistakes}{sec:embrace-mistakes}
