\chaplbl{The Carpentries}{sec:carpentries}{0}{0}
...
\figlbl{Software Carpentry and Data Carpentry Comparison}{fig:swc-vs-dc}{fig/swc-vs-dc.png}

\seclbl{Workshop Operations}{sec:workshop-operations}
...
\seclbl{What Costs What?}{sec:what-costs-what}
...
\seclbl{Materials}{sec:materials}
...
\seclbl{Using the Names}{sec:using-the-names}
...
\seclbl{Who Can Teach What}{sec:who-can-teach-what}
...
\seclbl{The Carpentry Community}{sec:the-carpentry-community}
...
\seclbl{A Culture of Contribution}{sec:a-culture-of-contribution}
...
\seclbl{Lesson Contribution}{sec:lesson-contribution}
...
\seclbl{Lesson Incubation}{sec:lesson-incubation}
...
\seclbl{Beyond Lessons}{sec:beyond-lessons}
...
\seclbl{Governance}{sec:governance}
