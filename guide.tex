t\chaplbl{Teacher's Guide}{s:guide}
...
immediately useful first'' approach described in \secref{s:motivation}.
...
\textit{The Big Picture: Education is Everyone's Business} \cite{bib:littky-big-picture},
