...
diagram} (taken from
\href{http://extremepresentation.typepad.com/blog/2006/09/choosing_a_good.html}{a
...
\begin{quote}
\subsection{Concept Mapping}\label{concept-mapping}
...
\begin{quote}
\subsection{The Serial Position
Effect}\label{the-serial-position-effect}
...
implements an interactive version of this exercise. \{: .challenge\}
\end{quote}
...
memory could hold
\href{https://en.wikipedia.org/wiki/The_Magical_Number_Seven,_Plus_or_Minus_Two}{7±2
...
form the
\href{https://en.wikipedia.org/wiki/Serial_position_effect}{memory
