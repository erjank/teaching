...
break their software up into functions, automate repetitive tasks,
keep track of their work using version control, and write lots of
little tests as they go along.
...
techniques, these practices can be taught and learned, and pay off
quickly and dramatically.  Adopting them won't automatically make you
a great teacher, but they \emph{will} make you a better teacher.
...
That training course is the basis of this short guide.  Its aim is
give you a quick, useful introductions to what we know about teaching
and learning and why we believe it is true.  We will look at:
...
start by presenting three practices that you can use while taking such
a class, as well as in the workshops you teach yourself.
